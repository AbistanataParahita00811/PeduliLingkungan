...
@section('content')
    <div class="mb-4">
        <h1 class="text-base font-semibold text-forest">Tambah Banner</h1>
        <p class="text-xs text-gray-600 mt-1">
            Atur tampilan hero di homepage. Pilih mode <span class="font-semibold">Default</span> atau
    ...
    <form
        ...
        x-data="{ isDefault: @json((bool) old('is_default', true)) }"
    >
        @csrf
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4 border-b border-gray-100 pb-3">
            <div>
                ...
                <p class="text-xs text-gray-600 mt-1">
                    Centang untuk menggunakan struktur hero bawaan dengan gambar backdrop (opsional).
                    Kosongkan untuk menggunakan banner custom (judul, deskripsi, tombol CTA).
                </p>
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div class="space-y-3">
                <div>
                    ...
                    <x-admin.image-preview name="image" />
                    @error('image')
