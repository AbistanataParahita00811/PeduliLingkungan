...
<head>
    ...
    <title>Login — Peduli Lingkungan Admin</title>
...
<body class="min-h-screen font-body antialiased">
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-forest relative overflow-hidden items-center justify-center p-12">
            ...
            <span class="floating-leaf absolute left-[15%] top-[20%] text-lime/40" aria-hidden="true"><x-icons name="leaf" class="w-12 h-12" /></span>
            <span class="floating-leaf absolute right-[20%] top-[30%] text-spring/30" style="animation-delay: 1s" aria-hidden="true"><x-icons name="leaf" class="w-8 h-8 rotate-45" /></span>
            <span class="floating-leaf absolute left-[25%] bottom-[30%] text-leaf/30" style="animation-delay: 2s" aria-hidden="true"><x-icons name="leaf" class="w-10 h-10 -rotate-12" /></span>
            <div class="relative z-10 max-w-md text-center">
                <div class="mb-8"><x-icons name="leaf" class="w-16 h-16 mx-auto text-lime" /></div>
        ...
        <div class="flex-1 flex items-center justify-center p-6 sm:p-12 bg-cream">
            <div class="w-full max-w-md">
                <div class="text-center mb-8 lg:hidden">
                    <x-icons name="leaf" class="w-12 h-12 mx-auto text-leaf mb-2" />
                    <h1 class="font-heading text-xl text-forest">Peduli Lingkungan</h1>
                    <p class="text-sm text-muted">Admin Dashboard</p>
                </div>

                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                    <h2 class="font-heading text-2xl text-forest mb-1">Selamat Datang</h2>
                    <p class="text-sm text-moss/70 mb-6">Masuk ke dashboard admin</p>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username"
                                    ...
                                    placeholder="admin@pedulilingkungan.id">
                            </div>
                        </div>
                        <div>
