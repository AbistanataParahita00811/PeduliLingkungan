...
<head>
    ...
    <title>500 — Terjadi Kesalahan | Peduli Lingkungan</title>
...
<body class="min-h-screen bg-cream font-body antialiased flex items-center justify-center px-4">
    <div class="text-center">
        ...
        <h1 class="font-heading text-6xl md:text-8xl text-forest/30 mb-2">500</h1>
        <h2 class="font-heading text-xl md:text-2xl text-forest mb-4">Terjadi kesalahan server</h2>
        <p class="text-moss/80 text-sm max-w-sm mx-auto mb-8">
            Maaf, ada masalah di sisi server. Silakan coba lagi nanti atau hubungi administrator.
        </p>
